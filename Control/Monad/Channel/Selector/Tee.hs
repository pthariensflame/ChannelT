...
runTee (FreeT a) = FreeT $ a >>= \x -> case x of
  ...
  Free (SyncChannel AwaitLeftTee _ iL) -> runFreeT . runWye $ il ()
  Free (SyncChannel AwaitRightTee _ iR) -> runFreeT . runWye $ iR ()
  Free (SyncChannel YieldTee _ iU) -> runFreeT . runWye $ iU ()
